  ...
  const handleSubmit = async (event) => {
    ...
    if (payload.error) {
      ...
      const response = await fetch("/api/checkout", {
        ...
        body: JSON.stringify({ address: address, ...payload }),
      });
  ...
  return paymentMethod ? (
    <div className="Result">
      ...
      <div className="ResultMessage">
        Your order is being processes {paymentMethod.id}
      </div>
...
const CheckoutPage = () => {
  ...
  return (
    <Fragment>
      ...
      <Container style={{ paddingLeft: "13%", paddingTop: "5%" }}>
        <Row>
          <Col>
          ...
          <Col>
            <div className="AppWrapper">
              <Elements stripe={stripePromise} options={ELEMENTS_OPTIONS}>
                <CheckoutForm sum={sum} address={address} />
              </Elements>
            </div>
          </Col>
        </Row>
